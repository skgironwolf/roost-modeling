...
for i=1:nRoosts
    ...
    mkdir('/Users/saadiagabriel/Desktop/plots2/LowestSweep',folderName);
    saveas(figure(1),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'figure 1'),'jpeg');
    % radial velocity
    %     figure(2);
    ...
    saveas(figure(2),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'figure 2'),'jpeg');
    ...
    saveas(figure(3),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'figure 3'),'jpeg');
