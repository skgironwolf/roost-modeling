...
%     
    if(dzPoints(i) > 90)&&not(strcmp(fileName,'/Users/saadiagabriel/Desktop/KDOX/2011/10/05/KDOX20111005_111131_V04.gz')&&(theRoost.sequence_id == 1630))...
            &&not(strcmp(fileName,'/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_112758_V04.gz')&&(theRoost.sequence_id == 1635))...
...
%     subplot(2,1,2);%:smoothed;
    ...
    m(i) = m1;
    v(i) = v1;
%     plot(generalCurve,DTC,AR);
%     xlabel('Distance From Roost Center');
%     ylabel('Reflectivity');
%     line([radius radius], ylim, 'Color', 'r', 'LineWidth', 2);
%     saveas(figure(1),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'smoothedPlot_500m'),'jpeg');
...
save('roostdev_1.75Cutoff','c1','s','r','m','v');