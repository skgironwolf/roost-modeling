...
%     
    ...
    inds = DIST_FROM_ROOST <= 1.75*radius; %changed from DIST_FROM_ROOST <= 2*radius
    ...
    [generalCurve,gof] = fit(DTC,AR,'gauss1');
    ...
    %saveas(figure(1),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'smoothedPlot_1.75XRADIUS'),'jpeg');
...
save('roostdev_smoothed2','c1','s','r','m','v');