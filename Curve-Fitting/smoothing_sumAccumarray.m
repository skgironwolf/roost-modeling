...
%1.75XRADIUS
     if(dzPoints(i) > 90)&&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_114700_V04.gz')&&(theRoost.sequence_id == 1636))...
             &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_115700_V04.gz')&&(theRoost.sequence_id == 1636))...
             &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/07/KDOX20111007_111205_V04.gz')&&(theRoost.sequence_id == 1650))...
             &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/07/KDOX20111007_111205_V04.gz')&&(theRoost.sequence_id == 1651))
    
%2XRADIUS
%      if(dzPoints(i) > 90)...
%              &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/05/KDOX20111005_111131_V04.gz')&&(theRoost.sequence_id == 1630))...
%              &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_112758_V04.gz')&&(theRoost.sequence_id == 1635))...
%              &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_113700_V04.gz')&&(theRoost.sequence_id == 1635))...
%              &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/06/KDOX20111006_114700_V04.gz')&&(theRoost.sequence_id == 1636))...
%              &&not(strcmp(fileName, '/Users/saadiagabriel/Desktop/KDOX/2011/10/09/KDOX20111009_112844_V04.gz')&&(theRoost.sequence_id == 1665))...
%              &&not(strcmp(fileName,'/Users/saadiagabriel/Desktop/KDOX/2011/10/17/KDOX20111017_120400_V04.gz')&&(theRoost.sequence_id == 1669))
    ...
    SR = accumarray(subs,M,[],@sum);
    SR = SR(SR ~= 0);
    DTC = accumarray(subs,N,[],@median);
    DTC = DTC(DTC ~= 0);
   
    subplot(2,1,2);%:smoothed;
    %figure(1)%:regular;
    [generalCurve,gof] = fit(DTC,SR,'gauss1');
    c1(i) = generalCurve.c1;
    r(i) = radius;
    [m1, v1] = meanVar(generalCurve); 
    m(i) = m1;
    v(i) = v1;
    plot(generalCurve,DTC,SR);
...
%     ylabel('Reflectivity');
%     
 saveas(figure(1),fullfile(strcat('/Users/saadiagabriel/Desktop/plots2/LowestSweep/',folderName), 'sumFit1.75'),'jpeg');
